...
public class BoundedGenerics {
	...
	public static void main(String[] args) {
		...
		HumanBeing humansObj = new HumanBeing("Pavitra", 23, 100, "Kansara",
				5.15);
		LivingGenerics<HumanBeing> humansGenericObj = new LivingGenerics<HumanBeing>(
				humansObj);
		humansObj = new HumanBeing("Mantra", 25, 90, "Kansara", 5.9);
		LivingGenerics<HumanBeing> humansGenericObj1 = new LivingGenerics<HumanBeing>(
				humansObj);
