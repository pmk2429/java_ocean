...
public class WordFrequency {
            ...
            while (!EOP) {
                ...
                if (inputChoice.equals("file") || inputChoice.equals("File")) {
                    if (args.length == 0) {
                        ...
                        mapWords = wordObj.calculateMaxRepeatedWordsFromFile(inputFile);
                        wordObj.printMaxWord(mapWords);
                    }
                }
                else if (inputChoice.equals("text") || inputChoice.equals("Text")) {
                    System.out.println("\nEnter the string to find the max repeated words:");
                    System.out.print("> ");
                    inputString = new Scanner(System.in);
                    String inputWords = inputString.nextLine();
                    Map<String, Integer> wordMap;
                    wordMap = wordObj.calculateMaxRepeatedWordsFromText(inputWords);
                    wordObj.printMaxWord(wordMap);
                }
                else {
                    System.out.println("-------------------------------------------------");
                    System.out.println("Enter your choice to find repeated words from:");
                    System.out.println("1) File\n2) Text");
                    System.out.print("> ");
                }
            }
    ...
    public Map<String, Integer> calculateMaxRepeatedWordsFromText(String inputString) {
